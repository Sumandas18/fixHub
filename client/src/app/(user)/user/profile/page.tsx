              ...
              <div className="usr-profile-card">
                ...
                <div className="usr-profile-stat">
                  <div className="usr-profile-stat-item">
                    <p className="usr-profile-stat-value">{bookings.length}</p>
                    <p className="usr-profile-stat-label">Total Bookings</p>
                  </div>
                  <div className="usr-profile-stat-item">
                   <p className="usr-profile-stat-value">{bookings.filter(b=>b.status=='completed').length}</p>
                    <p className="usr-profile-stat-label">Complete service</p>
                  </div>
                  {/* <div className="usr-profile-stat-item">
